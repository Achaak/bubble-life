...
export interface CommonEvents {
  ...
  addShoppingActionInWaitingList: (params: AddShoppingActionInWaitingList) => void
  ...
  transferActionFromCancelListToCurrent: (params: TransferActionFromCancelListToCurrent) => void
  ...
  transferMessageFromWaitingListToCurrent: (params: TransferMessageFromWaitingListToCurrent) => void
